...
run_bert()
{
    ...
    for iter in {0..4} ; do
	export logfile="result_mult_host_closed_1node_Naccelerator_bert_${nb_reader_threads}readerthreads_${nb_accelerator}nbaccelerator_AI400X2_notuning_iter${iter}_PUB.log"
